...
EXCEL_PATH = constants.DATA_PATH / "ExcelUploadFormat_Candice.xlsx"
# constant for name of .json file
OUTPUT_PATH = constants.OUTPUT_PATH / "Candice.Routing.2018.json"
...
DATES = [("2018-01-01T", 7), ("2018-01-02T", 8), ("2018-01-03T", 9), ("2018-01-04T", 10), ("2018-01-05T", 11)]
STATE = "Maryland"
...
class DataExercise:
    ...
    def one_day(self, rowvalues, date, colNumber):
        ...
        # dictionary to store third set of availability times for each day when given two times
        availabilitytime3 = OrderedDict()
        ...
        # if the doctor's availability time has to be split up
            ...
            self.helper_one_day(firsttime, availability, availabilitytime2, date)
            self.create_times(availabilitytime3, 8, secondtime[0], date)
            self.create_times(availabilitytime3, 9, secondtime[1], date)
            self.list_of_availability.append(availabilitytime3)
        ...
        elif "" is rowvalues[colNumber]:
            availability[KEY_VALUES[8]] = date + "09:00:00.000Z"
            availability[KEY_VALUES[9]] = date + "17:00:00.000Z"
            self.list_of_availability.append(availability)
